 ...
 */
final class Version20221008013450 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE carrito (id INT AUTO_INCREMENT NOT NULL, cliente_id INT NOT NULL, precio_total NUMERIC(12, 2) NOT NULL, INDEX IDX_77E6BED5DE734E51 (cliente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
